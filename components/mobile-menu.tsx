        ...
        >
          ...
          <nav className="flex flex-col space-y-4 container mx-auto" style={{ maxWidth: '1440px', width: '100%' }}>
            ...
            <a
              ...
              onClick={handleLinkClick}
              className="inline-flex min-h-[52px] w-full items-center justify-center rounded-full bg-gradient-to-r from-blue-500 to-blue-600 px-6 py-4 text-base font-semibold text-white shadow-md touch-manipulation active:scale-[0.99]"
            >
