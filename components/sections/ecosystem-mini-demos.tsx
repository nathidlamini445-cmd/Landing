...
export function MiniOperationalDemo({ embedded }: { embedded?: boolean } = {}) {
  ...
  const inner = (
    <div className="rounded-xl border border-sky-100/80 bg-gradient-to-br from-sky-50/50 to-white p-4 sm:p-5">
      ...
      <p className="mt-1 text-[13px] leading-snug text-slate-600 sm:text-sm">
        Three taps. DreamScale previews the next operational moves—lightweight, founder-real.
      </p>
      {lockedBeforePreview ? (
        <div className="mt-4">
  ...
  const inner = (
    <div
      className={cn(
        ...
        embedded
          ? "border-sky-100/80 bg-gradient-to-br from-sky-50/40 to-white"
