        ...
        <div className="mx-auto max-w-2xl" style={{ minHeight: "180px" }}>
          <AnimatePresence mode="wait">
            <motion.figure
              ...
              className="rounded-2xl border border-slate-200/85 bg-gradient-to-b from-slate-50/90 to-white px-6 py-9 text-center shadow-[0_14px_44px_-28px_rgba(15,23,42,0.2)] sm:px-10 sm:py-11"
            >
