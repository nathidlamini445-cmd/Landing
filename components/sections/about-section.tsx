...
const solves = [
  "Stop juggling many workspaces. Run your tools, team, and data from one place.",
  "Stop losing track of who does what. Shared plans with clear owners keep work moving.",
  "Stop chasing numbers across tabs. Your revenue, targets, and progress stay in one view.",
]

function SolveList() {
  return (
    <ul className="mx-auto mb-12 max-w-2xl space-y-4 text-left">
      {solves.map((line) => (
        <motion.li
          key={line}
          ...
          className="flex items-start gap-3 text-slate-800 text-[clamp(1rem,1.8vw,1.125rem)] leading-snug font-medium"
        >
          <span
            className="mt-0.5 flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-[rgb(0,149,255)]/10 text-[rgb(0,149,255)]"
            aria-hidden
          >
