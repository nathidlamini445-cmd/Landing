...
export function AboutSection() {
  return (
    <section id="about" className="min-h-svh flex items-center justify-center relative py-20">
      <div className="container px-4">
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-sentient font-bold text-slate-900 mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
          {values.map((value, index) => (
            <motion.div
              key={value.title}
              className="backdrop-blur-md bg-white/40 border border-blue-200/50 rounded-2xl p-6 hover:bg-white/60 hover:border-blue-300/60 transition-all duration-300 group shadow-lg shadow-blue-500/5"
            ...
            >
              ...
              <h3 className="text-xl font-sentient font-semibold text-slate-800 text-center mb-4">{value.title}</h3>
              <p className="text-slate-600 text-sm text-center leading-relaxed">{value.description}</p>
            </motion.div>
          ))}
        </div>
      </div>
