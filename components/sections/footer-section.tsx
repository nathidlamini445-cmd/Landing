...
export function FooterSection() {
  ...
  return (
    ...
    >
      {/* CTA Section */}
      <div className="container mx-auto flex-1 flex flex-col items-center justify-center -mt-27 sm:-mt-31 md:-mt-35 lg:-mt-39" style={{ maxWidth: '1440px', width: '100%' }}>
        <div
          ...
          style={{ width: '100%' }}
        >
          <h2 className="font-bold text-slate-900 mb-3 sm:mb-4 md:mb-6" style={{ fontSize: 'clamp(1.5rem, 2.5vw, 2.5rem)' }}>Ready to Scale Your Dreams?</h2>
          <p className="text-slate-600 mb-4 sm:mb-6 md:mb-8 lg:mb-10 max-w-2xl mx-auto" style={{ fontSize: 'clamp(1rem, 1.2vw, 1.125rem)' }}>
