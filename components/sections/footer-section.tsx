  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-6 flex-1 flex flex-col items-center justify-center">
        <div
          className={`text-center max-w-4xl transition-all duration-1000 backdrop-blur-md bg-white/40 border border-blue-200/50 rounded-3xl p-12 shadow-lg shadow-blue-500/5 ${
            isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
          }`}
        >
          <h2 className="text-4xl md:text-6xl font-bold text-slate-900 mb-6">Ready to Scale Your Dreams?</h2>
          ...
          >
            <a
              ...
              className="inline-flex items-center justify-center px-8 py-4 rounded-lg bg-gradient-to-r from-blue-500 to-blue-600 text-white font-semibold text-lg transition-all duration-300 hover:from-blue-600 hover:to-blue-700 hover:scale-105 hover:shadow-lg hover:shadow-blue-500/25"
            >
              Get Started Free
            </a>
          </div>
      ...
      <footer className="w-full border-t border-blue-200/50 mt-20 backdrop-blur-md bg-white/30">
