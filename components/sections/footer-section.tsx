...
export function FooterSection() {
  ...
  return (
    <section
      ref={sectionRef}
      id="footer"
      className="relative min-h-0 sm:min-h-screen flex flex-col items-center justify-center py-4 sm:py-8 md:py-12 lg:py-24"
    >
      {/* CTA Section */}
      <div className="container mx-auto px-4 sm:px-6 flex-1 flex flex-col items-center justify-center">
        <div
        ...
        >
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-6xl font-bold text-slate-900 mb-3 sm:mb-4 md:mb-6 px-4">Ready to Scale Your Dreams?</h2>
          <p className="text-slate-600 text-base sm:text-lg md:text-xl mb-4 sm:mb-6 md:mb-8 lg:mb-10 max-w-2xl mx-auto px-4">
            Join the innovators, dreamers, and builders who are transforming their visions into reality with DreamScale.
          </p>
          ...
          >
            <a
              ...
              className="inline-flex items-center justify-center px-6 sm:px-8 py-3 sm:py-4 rounded-lg bg-gradient-to-r from-blue-500 to-blue-600 text-white font-semibold text-base sm:text-lg transition-all duration-300 hover:from-blue-600 hover:to-blue-700 hover:scale-105 hover:shadow-lg hover:shadow-blue-500/25 w-full sm:w-auto max-w-xs sm:max-w-none"
            >
              Get Started Free
            </a>
          </div>
