    ...
    >
      ...
      <div className="container mx-auto flex-1 flex flex-col items-center justify-center mt-8 sm:mt-12 md:mt-16 lg:mt-20 mb-12 sm:mb-16 md:mb-20 lg:mb-24" style={{ maxWidth: '1440px', width: '100%' }}>
        <div
          ...
          style={{ width: '100%' }}
        >
          <h2 className="font-bold text-slate-900 mb-4 sm:mb-5 md:mb-6" style={{ fontSize: 'clamp(1.5rem, 2.5vw, 2.5rem)' }}>Ready to Scale Your Dreams?</h2>
          <p className="text-slate-600 mb-6 sm:mb-7 md:mb-8 lg:mb-10 max-w-2xl mx-auto" style={{ fontSize: 'clamp(1rem, 1.2vw, 1.125rem)' }}>
