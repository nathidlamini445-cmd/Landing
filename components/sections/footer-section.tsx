    ...
    >
      ...
      >
        ...
        >
          ...
          >
            Create your free account, connect your goals, and see competitor intel, Venture Quests, and Bizora AI in one
            place. No credit card required to start.
          </p>
          <div
            className={`flex justify-center relative transition-all duration-700 ${
              isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
            }`}
