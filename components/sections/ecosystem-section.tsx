  ...
  const products = [
    {
      ...
      description:
        "Stop guessing who you're really competing with and map direct and indirect players before you pour money into ads or builds. Turn messy research into a clear read on strengths, weaknesses, and the positioning only you can own. Follow a guided wizard so a blank page becomes structured analysis and sharper decisions. Leave with summaries and exportable reports you can pitch, share, or revisit when the market moves.",
      icon: <CompetitorIntelligenceVisual />,
    },
    {
      title: "Bizora AI",
      description:
        "One workspace to think out loud with AI, brainstorm, draft, and stress-test ideas without hopping between a pile of tools. Get depth when you need it, with reasoning that unpacks problems instead of spitting shallow one-liners. Move fast with voice or fine-tune every line in text when precision matters. Keep organized threads and share when you're ready so your momentum survives between sessions.",
      icon: <BizoraAIVisual />,
    },
    {
      title: "Venture Quests",
      description:
        "Turn your biggest goals into quests across revenue, launches, audience, skills, or creative milestones with a real north star. Choose a lane and a timeline so vague ambition becomes something you can track week by week. Earn the feeling of progress with levels, streaks, and hooks that make consistency easier than raw willpower. Built for builders and operators who want accountability without living inside a spreadsheet.",
