...
const pillars = [
  ...
  },
  {
    ...
    description:
      "Venture Quests, Bizora AI, and competitor intel live in one flow. Fewer context switches mean faster shipping and fewer moments when no one remembers where the note lived.",
    icon: "execute",
  },
  {
